...
此外，如果您想要将文献的标题添加到标注中，您在标注详情中找不到它。相反，您可以在所属文献的详细信息中找到它，存储在 `it.docItem` 中。因此，要添加标题，您可以在标注模板中使用 `<%= it.docItem.title %>`。
...
### 批量导入批注的模板 [#note-annots-template]
