...
## Importing Annotations into Literature Notes [#import-annotations]

<Steps>

### Select Literatures in Zotero Library [#select-literatures]
...
### Literature Notes in Obsidian [#literature-notes-imported]
