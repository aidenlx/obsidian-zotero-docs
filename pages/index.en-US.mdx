...
<Cards>
  <Card icon={<FaDownload />} title="Installation" href="/getting-started/install/" />
  <Card icon={<FaHammer />} title="Basic Usage" href="/getting-started/basic-usage/" />
</Cards>
...
Special thanks to [@FeralFlora](https://github.com/FeralFlora) and [@MichaTarlton](https://github.com/MichaTarlton) for writing the tutorial around this project before the documentation is completed.